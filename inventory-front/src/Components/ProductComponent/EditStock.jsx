...
import { saveTransaction, generateTransactionId } from "../../Services/TransactionService";
...
const EditStock = () => {
  ...
  useEffect(() => {
    if (product.productId && flag === 2 && product.stock === 0 && !alertShown.current) {
  ...
  const getRate = () => (flag === 1 ? product.purchasePrice || 0 : product.salesPrice || 0);
      ...
      <div className="edit-stock-box">
        ...
        <div className="content-layout">
          ...
          <div className="left-side">
            ...
            <div className="product-detail"><strong>ID:</strong> {product.productId}</div>
            <div className="product-detail"><strong>SKU:</strong> {product.sku}</div>
            <div className="product-detail"><strong>Name:</strong> {product.productName}</div>
            <div className="product-detail"><strong>Vendor:</strong> {product.vendorId}</div>
            <div className="product-detail"><strong>Reorder Level:</strong> {product.reorderLevel}</div>
            <div className="product-detail"><strong>Stock:</strong> {product.stock}</div>
            <div className="product-detail"><strong>{flag === 1 ? "Purchase Price:" : "Sales Price:"}</strong>{" "} {flag === 1 ? product.purchasePrice : product.salesPrice} </div>
          ...
          <div className="info-card right-card">
            ...
            <div className="inner-card">
              ...
              <div className="form-group">
                ...
                <input type="text" value={transactionValue.toFixed(2)} readOnly />
              </div>

              <div className="buttons">
                <button className="btn-cancel" onClick={handleReturn}>Return</button>
